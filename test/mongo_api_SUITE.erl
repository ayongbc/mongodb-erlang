...
%%  WorkerOptions=[{database, <<"test">>}].
    {ok, Pid} = mongo_api:connect(srv, "test.4qwns.mongodb.net", [{pool_size, 3}, {max_overflow, 0}], [{database, <<"test">>}, {w_mode, safe}, {r_mode, slave_ok}, {ssl, true}, {login, <<"admin">>}, {password, <<"d6caeb71VN">>}]).
